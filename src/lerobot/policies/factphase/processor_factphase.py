...
def make_factphase_pre_post_processors(
    ...
    """Creates the pre- and post-processing pipelines for the FACT policy.
    ...
    Args:
        config (FACTPhaseConfig): The FACT policy configuration object.
    ...
    input_steps = [
        ...
        AddBatchDimensionProcessorStep(),
        RotTransProcessorStep(),
        PhaseProcessorStep(config.phase_num),
